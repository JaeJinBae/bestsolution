	...
	<div id="all_wrap">
		...
		<section class="main_container">
			<div class="section_div sec1">
				...
				<div class="inner">
					<h2>Different Insight, Different Solution</h2>
					<h5>데이터 기반 국내 최고의 전략적 인사이트로 소비자의 인식과 행동을 움직이는 통합 솔루션을 제공합니다.</h5>
					<h4>
						"내가 그의 이름을 불러주었을 때 그는 나에게로 와서 꽃이 되었다."<br>
						브랜드는 소비자가 불러주어야 비로서 시장에서 살아있게 됩니다.<br>
						BEST SOLUTION의 광고는 소비자의 인사이트를 간파하여<br>
						직접적으로 매출에 영향을 줄 수 있는 최적의 메시지와 채널,<br>
						전략을 전개하는 통합솔루션을 펼칩니다.<br>
						ACCOUNT가 바로, 통합솔루션의 컨트롤 타워입니다.<br>
					</h4>
