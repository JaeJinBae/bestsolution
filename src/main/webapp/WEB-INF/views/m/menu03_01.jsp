							...
							<c:choose>
							    ...
							    <c:otherwise>
							        <c:forEach var="item" items="${list}">
										<li class="item">
											<a href="${pageContext.request.contextPath}/m/menu03_01read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}" style="background-image: url('${pageContext.request.contextPath}/resources/uploadPortfolio/${item.thumb_stored}');">
												<b>${item.title}</b>
											</a>
										</li>
									</c:forEach>
