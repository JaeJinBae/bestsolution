...
.board-notice-view ul li div.title {
    padding: 15px;
...
.board-notice-view ul li p.info {
    position: relative;
    padding: 15px;
    border-bottom: 1px solid #cfd1d4;
}
.board-notice-view ul li p.info i.date {
    font-size: 12px;
    color: #777;
}
.board-notice-view ul li p.info span.line {
    display: inline-block;
    font-size: 11px;
    color: #ccc;
    padding: 0 10px;
}
.board-notice-view ul li p.info i.hit {
    font-size: 12px;
    color: #777;
}
.board-notice-view ul li.con {
    padding: 15px;
    border-bottom: 1px solid #cfd1d4;
    font-size: 1em;
    line-height: 1.5em;
		...
		<section class="main_container">
			<div class="section_div sec1">
				<div class="inner">
							...
							<ul class="full">
								<li>
									...
									<c:choose>
										...
										<c:otherwise>
											<a href="${pageContext.request.contextPath}/m/menu03_01read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
										</c:otherwise>
									</c:choose>
								</li>
								<li>
									...
									<c:choose>
										...
										<c:otherwise>
											<a href="${pageContext.request.contextPath}/m/menu03_01read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
										</c:otherwise>
									</c:choose>
								</li>
							</ul>
					...
					<div class="btn-group">
						<div class="inner">
							<a href="${pageContext.request.contextPath}/m/menu03_01" class="btn btn-list">목록으로</a>
						</div>
					</div>
					<!-- 게시판 버튼 끝 -->
				</div><!-- inner end -->
